...
Although no on e has proved it yet, it is thought that some numbers, like
...
(i) become a palindrome in less than fifty iterations, or, (ii) no one,
...
for i in range(10000):
  ...
  if lych:
    lychrels += 1
    print(i)
print(lychrels, "Lychrel numbers < 10000 (tested to 50 iterations).")
